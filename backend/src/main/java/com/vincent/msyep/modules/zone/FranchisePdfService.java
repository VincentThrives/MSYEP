...
public class FranchisePdfService {
    ...
    public byte[] buildMou(Zone zone) {
        ...
        byte[] giver = SignatureImage.clean(adminSignature.get());
        ...
        // for zones uploaded before the two signature fields were merged into one. Cleaned so a PDF /
        // photo upload becomes a transparent-background stamp that never covers the document.
        ...
        zoneSign = SignatureImage.clean(zoneSign);
